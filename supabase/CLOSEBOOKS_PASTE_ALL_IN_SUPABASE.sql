-- ═══════════════════════════════════════════════════════════════════════════
-- CLOSEBOOKS: RUN THIS ENTIRE FILE ONCE IN SUPABASE SQL EDITOR (PRODUCTION)
-- Prerequisites: public.firms, public.clients, public.jobs must already exist.
-- ═══════════════════════════════════════════════════════════════════════════

-- ─── 0) subscriptions table (Stripe) if missing ──────────────────────────
...
-- ─── 1) Business data RLS (20260414000000) ─────────────────────────────────
...
-- ─── 2) Subscription columns (20260415000001) ─────────────────────────────
...
-- ─── 3) Firm members + audit (20260416000000) ─────────────────────────────
